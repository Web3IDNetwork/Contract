...
/**
   Web3ID Network Protocol
   Web3ID is an artificial intelligence identity ID project created using Python,
   NodeJS, (RL - Reinforcement Learning) for use in Cryptocurrency, metaverse and blockchain technologies.
   www.web3id.network
*/
...
contract Web3ID is Context, IERC20, Ownable {
    ...
    string private _name = "Web3ID";
    string private _symbol = "W3ID";
    ...
    address public charityWallet = 0xA03c4AEE84ac20F640B5f433A44c25897a8d2EE3;
